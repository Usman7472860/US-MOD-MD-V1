...
const { approvePayment, rejectPayment, checkPaid, pendingPayments, isPaidUser } = require('./commands/payment');
...
const { namazCommand } = require('./commands/namaz');
const { hadithCommand, bookCommand, getBooksListMessage, HADITH_BOOKS, findBookKey } = require('./commands/hadith');
...
break
            ...
            case userMessage.startsWith('.sim'): {
                ...
                try {
                    ...
                    replyText += `━━━━━━━━━━━━━━━━━━\n`;
                    replyText += `_Powered by M Usman Chachar_`;
